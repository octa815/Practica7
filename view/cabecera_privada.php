    ...
    <header>
        ...
        <aside>
            ...
            <aside id="panel" class="lateral">
                ...
                <a href="index.php" class="icon-trash-empty">Darme de baja</a>
                <a href="index.php" class="icon-logout">Cerrar sesión</a>  
        ...
        <nav id="menu"> 
            ...
            <ul>
                ...
                <li><a href="index.php" class="icon-logout"><span>Cerrar sesión</span></a></li>                  
            </ul>   
        </nav>   
    </header>